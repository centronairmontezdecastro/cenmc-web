...
public class EnviarEmail implements Serializable{
	...
	private String login = "nairmontezdecastro@gmail.com";
	private String senha = "mmc141175";
	/*
	...
	public boolean sendMail(String from, String to, String subject, String message) {
		...
		try {
			 ...
			 */
			tr.connect(mailSMTPServer, this.login, this.senha);
